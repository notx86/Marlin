...
// Need to calibrate against degree; setting to 80 steps/unit for all axes for now
/**
...
// Need to calibrate ; setting to 300 mm/s for all axes for now
...
// Need to calibrate ; setting to 3000 mm/s^2 for all axes for now
